        ...
        data = {
            orc = { -- archetype
                ...
                unit_types = { 
                    ...
                    "Afterlife Orcish Leader", "Afterlife Orcish Ruler", "Afterlife Orcish Sovereign"
                },
    ...
    },
    {
        ...
        data = {
            assassin = { -- archetype
                ...
                BLUEISH_BROWN = { frequency = 1.0, colors = "b3785d,66333d,b3785d,997d76,997d76,57404e,242b4a,57404e,242b4a" },
                REDDISH_GREEN = { frequency = 1.0, colors = "b17632,5e3535,c5956a,949473,91822f,525239,4f2d29,514a3f,4f2d29" },
                BROWNISH = { frequency = 1.0, colors = "c7772c,573436,b79c80,929466,8f6c61,6b4936,472b27,475044,472b27" },
                BLUEISH = { frequency = 1.0, colors = "997a6b,130d25,b3927e,997a6b,876f69,4e495f,0f2a3f,4e495f,0f2a3f" },
                BROWNISH_RED = { frequency = 1.0, colors = "ae6a42,662431,db9651,ae6a42,826e2f,75491e,3f1519,47213c,3f1519" },
                BLUEISH_BROWN_COMBO = { frequency = 1.0, colors = "b27e34,5f2e2f,b08860,968874,8f7960,58473f,282c30,4f4247,292c3c" },
				REDDISH_GREEN_COMBO = { frequency = 1.0, colors = "b17d1f,5b2f2b,b99766,949473,8b7c3d,565034,3d2d20,4c473f,3e2d2b" },
                BROWNISH_COMBO = { frequency = 1.0, colors = "bc7e1c,582e2b,b29a71,93946c,8a7156,624c33,392c1f,474a42,3a2c2a" },
                BLUEISH_COMBO = { frequency = 1.0, colors = "a57f3b,361b23,b09570,96876f,86725a,544c47,1d2b2b,4b464f,1e2c36" },
                BROWNISH_RED_COMBO = { frequency = 1.0, colors = "b07727,5f2629,c4975a,a17f5a,83723d,674c27,352118,47323e,362123" },
