...
local body_parts = {
	{
		...
		data = {
			...
			wolf = { -- archtype
				...
				TIMBER = { frequency = 1.0, colors = "f0e9ae,f3c274,a59077,796433,494a46,4d1d08" },
				RUSSET = { frequency = 1.0, colors = "ffd3a7,d09b4c,a35b67,494a46,18222d,4d1d08" },
				SLATE = { frequency = 1.0, colors = "ffd3a7,cd9d6f,826c79,4a503e,2c2319,4d1d08" },
				TAWNY = { frequency = 1.0, colors = "f8deab,e2af60,a4766f,61573d,31363a,4d1d08" },
				DUSTY = { frequency = 1.0, colors = "f8deab,e0b072,947e78,625a39,3b3730,4d1d08" },
				SILVER_GREY = { frequency = 0.1, colors = "d0cbdd,859a94,826c79,4a503e,2c2319,4d1d08" },
				RUBY_GREY = { frequency = 0.1, colors = "d0cbdd,859a94,826c79,4a503e,2c2319,4d1d08" },
				SILVER_BLUE = { frequency = 0.1, colors = "e8cfc2,a99c82,826c79,4a503e,2c2319,4d1d08" },
